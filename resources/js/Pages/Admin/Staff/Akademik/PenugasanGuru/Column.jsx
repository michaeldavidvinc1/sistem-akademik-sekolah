...
export const columns = [
    ...
    {
        accessorKey: "mataPelajaran.nama_mata_pelajaran",
        header: "Mata Pelajaran",
    },
    {
        accessorKey: "guru.nama_lengkap",
        header: "Nama Guru",
    },
    {
            ...
            const handleDelete = (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        router.delete(route("staff.penugasan.destroy", id), {
                            onSuccess: () => {
                                toast({
                                    variant: "success",
                                    title: "Success!",
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem>
                            <Link
                                href={route("staff.penugasan.edit", data.id)}
